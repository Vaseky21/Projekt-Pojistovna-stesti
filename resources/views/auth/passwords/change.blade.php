            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user-password.update') }}">
                        ...
                        <div class="row mb-3">
                            <label for="current_password" class="col-md-4 col-form-label text-md-end">{{ __('Původní heslo') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end">{{ __('Nové heslo') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('Potvrdit heslo') }}</label>
